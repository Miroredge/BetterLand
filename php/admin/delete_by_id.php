<?php 
    ...
    if(isset($_POST['user_id']))
    {
        ...
        if ($id != "")
        {
            header("Location:/php/admin/delete.php?table=users&id=" . $id);
        }
        else
        {
            $_SESSION["error"] = "L'id de l'utilisateur n'a pas été renseigné.";
            header("Location:/php/admin/delete_by_id.php?table=users");
        }
    }
    if(isset($_POST['role_id']))
    {
        ...
        if ($id != "")
        {
            header("Location:/php/admin/delete.php?table=roles&id=" . $id);
        }
        else
        {
            $_SESSION["error"] = "L'id du rôle n'a pas été renseigné.";
            header("Location:/php/admin/delete_by_id.php?table=roles");
        }
    }
    if(isset($_POST['p_cat_id']))
    {
        ...
        if ($id != "")
        {
            header("Location:/php/admin/delete.php?table=primary_cats&id=" . $id);
        }
        else
        {
            $_SESSION["error"] = "L'id de la catégorie primaire n'a pas été renseigné.";
            header("Location:/php/admin/delete_by_id.php?table=primary_cats");
        }
    }
    if(isset($_POST['category_id']))
    {
        ...
        if ($id != "")
        {
            header("Location:/php/admin/delete.php?table=categories&id=" . $id);
        }
        else
        {
            $_SESSION["error"] = "L'id de la catégorie n'a pas été renseigné.";
            header("Location:/php/admin/delete_by_id.php?table=categories");
        }
    }
    if(isset($_POST['product_id']))
    {
        ...
        if ($id != "")
        {
            header("Location:/php/admin/delete.php?table=products&id=" . $id);
        }
        else
        {
            $_SESSION["error"] = "L'id du produit n'a pas été renseigné.";
            header("Location:/php/admin/delete_by_id.php?table=products");
        }
    }
...
<html>
    ...
    <h1><a href="/" id="title-page">PaperLand</a></h1>
        <section id="section-modifier" class="section-form">
            <div class="div-form">
                <h2>Supprimer <?= $subject ?></h2>
                <?php echo '<form action="../admin/delete_by_id.php?table=' . $table . '" method="POST" class="form">' ?> 
                    <div class="item-form">
                        <div class="flashes">
                    ...
                    <div class="item-form">
                        <input class="button-form" type="submit" value="Supprimer"/>
